...
export default function Contact() {
  return (
    <div className="md:p-20 p-5 dark:text-white text-slate-800 text-center">
      <Container>
        ...
        <div className="mt-5 md:mt-20 flex flex-col md:flex-row gap-5 px-2 md:px-0">
          ...
          <form className="w-full">
            <input
              className="w-full p-5 border-0 dark:bg-white bg-gray-100 rounded mb-5 focus:outline-secondary2"
