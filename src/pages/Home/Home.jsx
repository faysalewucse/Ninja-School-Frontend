...
export const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <SwiperSlide>
          <div className="p-10 md:p-20 dark:bg-slate-900 dark:text-white text-slate-700">
            <Container>
        ...
        <SwiperSlide>
          <div className="relative">
            <img
              className="w-full h-[95vh] object-cover blur-sm"
              src={slider2}
              alt=""
            />
            <div className="absolute bg-black bg-opacity-50 p-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
              ...
              <p className="text-3xl my-10">
                Step into Our Martial Arts Sanctuary, Where the Perfect Balance
                of Tradition, Expertise, and Personal Growth Converge
              </p>
